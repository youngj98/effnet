...
class CustomHead(torch.nn.Module):
    def __init__(self, num_ftrs):
        ...
        self.fc_weather = torch.nn.Linear(num_ftrs, 4)  # Assuming 4 classes for climate

    def forward(self, x):
        climate = self.fc_weather(x)
        return climate
...
def main(image_path, model_path):
    ...
    with torch.no_grad():
        ...
        plot_image_with_predictions(image.squeeze(0), probabilities, true_label=None, pred_label=predicted_climate, name=file_name, class_names=class_names)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="/home/ailab/young/EfficientNet-PyTorch/best_weather_model_e10_lr0001_s01.pth", help="Path to the model weights")
